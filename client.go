...
func (c *Client) GetDropletByAppGuid(guid string) ([]byte, error) {
	r := c.NewRequest("GET", "/v2/apps/"+guid+"/droplet/download")
...
func (c *Client) GetAppBitsByDownloadUrl(downloadUrl string) (*http.Response, error) {
